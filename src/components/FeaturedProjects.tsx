...
const FeaturedProjects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      categoryFilter: "modular-kitchen",
              ...
              <CarouselContent className="-ml-2 md:-ml-4">
                {projects.map((project, index) => (
                  <CarouselItem key={project.id} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3">
                    <Card className="group project-card hover-lift border-0 shadow-soft overflow-hidden">
                      <div className="relative overflow-hidden aspect-[4/3]">
                        ...
                        <div className="absolute top-4 left-4 z-10">
                          ...
                          >
                            <span className="bg-primary/90 text-primary-foreground px-3 py-1 rounded-full text-sm font-medium shadow-md backdrop-blur-sm hover:bg-primary transition-colors duration-300 cursor-pointer">
                              {project.category}
                            </span>
                          </Link>
                        </div>
