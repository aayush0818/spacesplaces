...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative w-full h-screen overflow-hidden">
      ...
      {/* Hero Content - Fixed positioning and proper constraints */}
      <div className="absolute inset-0 z-20 flex items-center justify-center">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center max-w-5xl mx-auto">
            
            {/* Main Heading - Properly sized and responsive */}
            <div className="mb-6">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-montserrat font-bold text-white leading-tight">
                Transform Your
            ...
            <div className="mb-8">
              <p className="text-lg sm:text-xl md:text-2xl text-white leading-relaxed font-medium drop-shadow-lg max-w-4xl mx-auto">
            ...
            {/* Stats Section - Better responsive grid */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="text-center group hover-lift bg-black/30 backdrop-blur-md border border-white/30 rounded-xl p-6 transition-all duration-300 hover:bg-black/40 hover:border-primary/50">
                <div className="text-3xl md:text-4xl lg:text-5xl font-montserrat font-bold text-primary-glow mb-2 transition-transform group-hover:scale-110 drop-shadow-lg">150+</div>
                <div className="text-white font-semibold text-lg mb-1">Projects Completed</div>
                <div className="text-white/80 text-sm">Luxury Spaces Crafted</div>
              </div>
              <div className="text-center group hover-lift bg-black/30 backdrop-blur-md border border-white/30 rounded-xl p-6 transition-all duration-300 hover:bg-black/40 hover:border-primary/50">
                <div className="text-3xl md:text-4xl lg:text-5xl font-montserrat font-bold text-primary-glow mb-2 transition-transform group-hover:scale-110 drop-shadow-lg">12+</div>
                <div className="text-white font-semibold text-lg mb-1">Years Experience</div>
                <div className="text-white/80 text-sm">Design Excellence</div>
              </div>
              <div className="text-center group hover-lift bg-black/30 backdrop-blur-md border border-white/30 rounded-xl p-6 transition-all duration-300 hover:bg-black/40 hover:border-primary/50">
                <div className="text-3xl md:text-4xl lg:text-5xl font-montserrat font-bold text-primary-glow mb-2 transition-transform group-hover:scale-110 drop-shadow-lg">98%</div>
                <div className="text-white font-semibold text-lg mb-1">Client Satisfaction</div>
                <div className="text-white/80 text-sm">Happy Homeowners</div>
              </div>
            </div>
          </div>
        </div>
