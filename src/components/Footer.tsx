          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center space-x-3 mb-4">
                <img src="/lovable-uploads/6758e494-f0c1-4824-89b5-b93e2eda51f3.png" alt="Spaces & Places Logo" className="h-10 w-auto" />
                <div>
              ...
              <div className="flex space-x-4">
                <a href="https://www.instagram.com/spacesplacesinteriors?igsh=MW10cTNiM3I4czNhdA==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-background/10 rounded-full flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors hover-lift">
                ...
                <a href="https://youtube.com/@spacesplaces-interiorsolutions?si=CXah0YKRBrLZjENu" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-background/10 rounded-full flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors hover-lift">
            ...
            {footerSections.map(section => <div key={section.title}>
                ...
                <ul className="space-y-3">
                  {section.links.map(link => <li key={link.name}>
                      {link.href.startsWith('#') ? <a href={link.href} className="text-background/80 hover:text-primary transition-colors hover-lift">
                          {link.name}
                        </a> : <Link to={link.href} className="text-background/80 hover:text-primary transition-colors hover-lift">
                          {link.name}
                        </Link>}
                    </li>)}
                </ul>
