...
const Manufacturing = () => {
  const manufacturingSteps = [{
    ...
    advantages: ["Uniform bonding", "No bubbles or peeling", "Ensures edge integrity during cutting"],
    ...
    advantages: ["Pre-set drilling patterns", "Consistent hole depth and spacing", "Reduced human error"],
    icon: Cog
  }, {
    ...
    advantages: ["Precise cuts with 0.1 mm tolerance", "Minimizes material wastage", "Faster and cleaner than manual sawing"],
    ...
    advantages: ["Seamless finish with no glue marks", "Stronger bond with durability", "Water-resistant edge sealing"],
    icon: Wrench
  }, {
    ...
    advantages: ["Panels assembled with pre-drilled joints", "Quality hardware installation", "Polishing and cleaning for dust-free finish", "Reduced on-site labor and quick assembly", "Functionality of hinges and sliders"],
    icon: CheckCircle
  }, {
    ...
    advantages: ["Assembled by trained technicians", "Dust-free and fast installation", "Post-assembly clean-up"],
    icon: MapPin
  }];
  return <>
      <SEO title="Manufacturing Process - State-of-the-Art Furniture Production | Spaces & Places" description="Discover our advanced manufacturing facility featuring European machinery, precision cutting, laminate pressing, and quality assembly processes for custom furniture." keywords="furniture manufacturing, precision cutting, laminate pressing, quality assembly, European machinery, custom furniture production, Mumbai manufacturing" url="https://spacesandplaces.com/manufacturing" />
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4">
            ...
            <div className="space-y-20">
              ...
              return <div key={index} className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-12`}>
                    {/* Image Section */}
                    <div className="w-full lg:w-1/2">
                      <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                        <LazyImage src={step.image} alt={step.title} className="w-full h-[400px] object-cover" priority={index < 2} />
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      <div className="mb-6">
                        ...
                        <ul className="space-y-2">
                          {step.advantages.map((advantage, advIndex) => <li key={advIndex} className="flex items-start">
                      ...
                      {step.details && <div className="bg-secondary/20 rounded-lg p-6">
